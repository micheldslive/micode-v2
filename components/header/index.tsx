        ...
        <nav>
          <a href="/">
            <svg className={ style.logo } version="1.1" x="0px" y="0px" viewBox="-849 974 300 53">
              <g>
                <path className={ style.name } d="M-579.2,997.6c-1.2-3.3-3.8-6-7.1-7.1c-1.2-0.4-2.5-0.7-3.9-0.7h-7.8c-1.4,0-2.7,0.2-3.9,0.7
                ...
                <path className={ style.name } d="M-619.2,974.2c-2.2,0-3.9,1.7-3.9,3.9v12.4c-1.2-0.4-2.5-0.7-3.9-0.7h-7.8
                ...
                <path className={ style.name } d="M-652.7,997.6c-1.2-3.3-3.8-6-7.1-7.1c-1.2-0.4-2.5-0.7-3.9-0.7h-7.8c-1.4,0-2.7,0.2-3.9,0.7
                ...
                <path className={ style.name } d="M-688.8,1021c0,2.2-1.7,3.9-3.9,3.9h-15.6c-1.4,0-2.7-0.2-3.9-0.7c-3.3-1.2-6-3.8-7.1-7.1
                ...
                <path className={ style.name } d="M-764.8,1001.5v19.5c0,2.2-1.7,3.9-3.9,3.9s-3.9-1.7-3.9-3.9v-19.5c0-2.2-1.7-3.9-3.9-3.9
                ...
                <path className={ style.name } d="M-751.4,993.7v27.3c0,2.2-1.7,3.9-3.9,3.9s-3.9-1.7-3.9-3.9v-27.3c0-2.2,1.7-3.9,3.9-3.9
          ...
          <div className={ style.menu }>
            <a className={ style.theme } href='#' onClick={()=> setChange(theme)}>
              {change ? (
                <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none">
