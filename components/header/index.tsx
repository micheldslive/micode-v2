...
const Header: React.FC<ReduxType> = ({ states, setChange, setMenu }) => {
  const { change, menu } = states,
          ...
          <div className={style.menu}>
            ...
            <div className={cx(style.dropmn, { [style.active]: menu })}>
              <ul>
                <li>
                  <a
                    href="https://github.com/micheldslive/micode-v2/raw/master/download/Michel-Domingos.pdf"
                    download
                    rel=""
                  >
                    Download CV
